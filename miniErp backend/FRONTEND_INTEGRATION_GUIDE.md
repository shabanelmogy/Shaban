...
| 1 - Country and container data | Backend ready | Migration pending | Verified locally | Pending | Countries, Containers, StoreContainer assignments, and container-store selector implemented; not deployed by this task |
