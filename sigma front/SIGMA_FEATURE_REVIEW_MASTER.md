...
| Version | 1.1 |
| Last verified against documentation system | 2026-08-06 |
...
| Action | Visible when | Server permits when | Confirmation or input | Busy guard | Success effect | Refresh target | Failure recovery |
|---|---|---|---|---|---|---|---|
| | | | | | | | |
